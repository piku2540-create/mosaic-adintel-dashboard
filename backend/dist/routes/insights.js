...
import { computeBrandSummaries, getLongevityAds, detectGaps, generateAIInsights, computeCreativeStrength, computeAggressionScore, computeEmotionFormatMatrix, computePainOfferAlignment, } from '../services/insightService.js';
const router = Router();
